...
This folder contains the Argo CD application manifests that stand up the single-instance FoxIDs environment.
...
2. Deploy Argo CD and point it at `single-instance/app`.
...
- FoxIDs: `https://id.test-single-instance.foxids.com`
- FoxIDs Control: `https://control.test-single-instance.foxids.com`
- Argo CD: `https://argocd.test-single-instance.foxids.com`
- OpenSearch Dashboards: `https://opensearch.test-single-instance.foxids.com`
